...
public class T265Localizer implements Localizer {
    ...
    public T265Localizer(HardwareMap hardwareMap, boolean resetPos) {
        ...
        if (slamra == null) {
            slamra = new T265Camera(new Transform2d(new Translation2d(0,0), new Rotation2d(0)), 0.2, hardwareMap.appContext);
    ...
    public Pose2d getPoseEstimate() {
        ...
        if (up != null) {
            ...
            rawPose = new Pose2d(oldPose.getX() / .0254, oldPose.getY() / .0254, norm(oldRot.getRadians() + 0)); //raw pos and angle mod.
...
//        }
    ...
    public static double getHeading() {
        return norma(mPoseEstimate.getHeading() - 0); // angle mod
    }
     ...
     * @return normalized angle between ranges 0 to 2Pi
     */
