...
public class Robot extends TankDrive {
    ...
    public Robot(HardwareMap hardwareMap, Telemetry telemetry, String op) {
        ...
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, backLeftName);
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, backRightName);
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, frontRightName);
